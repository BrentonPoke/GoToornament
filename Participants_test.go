...
func TestParticipant(t *testing.T) {
	...
	disciplines := GetParticipants(&client,"4159532293277130752",ParticipantScope().VIEWER,NewParticipantRange(0,7))
...
func TestSingleParticipant(t *testing.T) {
	...
	discipline := GetParticipant(&client,"4159532293277130752",ParticipantScope().VIEWER,"4238002239210135552")
